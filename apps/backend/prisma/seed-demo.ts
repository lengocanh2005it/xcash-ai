...
const DEMO_TRANSACTIONS: SeedTransaction[] = [
  ...
  // --- Chi phí — đã định khoản tự động ---
  {
    ...
    classification: {
      ...
      classificationType: 'auto',
      classifiedBy: 'ai',
      reason: 'Chi lương nhân viên — chi phí quản lý (Nợ 642).',
      status: 'classified',
    },
  },
  {
  ...
  },
  {
    ...
    classification: {
      ...
      classificationType: 'auto',
      classifiedBy: 'ai',
      reason: 'Thuế môn bài — chi phí quản lý doanh nghiệp (Nợ 642).',
      status: 'classified',
    },
  },
  {
  ...
  },
  {
    ...
    classification: {
      ...
      classificationType: 'auto',
      classifiedBy: 'ai',
      reason: 'Lương tháng 5 — chi phí quản lý (Nợ 642).',
      status: 'classified',
    },
  },
  {
  ...
  },
  {
    ...
    classification: {
      ...
      classificationType: 'auto',
      classifiedBy: 'ai',
      reason: 'Mua nguyên liệu — chi phí mua hàng (Nợ 611).',
      status: 'classified',
    },
  },
];

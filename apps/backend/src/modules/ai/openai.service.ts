...
/**
 * Client provider — manages OpenAI/Jina/MiniMax clients.
 * Business logic split into: EmbeddingProviderService, ChatProviderService, CopilotAgentFactoryService.
 */
@Injectable()
export class OpenAiService {
  ...
  readonly jinaClient: OpenAI | null;
  readonly jinaModel: string;
  readonly minimaxClient: OpenAI | null;
...
Định khoản:`;
  ...
  buildCopilotSystemPromptForSimpleChat(financialContext: string): string {
